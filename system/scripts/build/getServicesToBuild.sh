...
IFS="," read -ra HARNESSCORE <<< "serverless-prepareRollback,serverless-deploy,ci-manager,ng-manager,platform-service,sto-manager,migrator,batch-processing,manager,access-control,ce-nextgen,template-service,pipeline-service,event-server,change-data-capture,srm-service,verification-service,bootstrap"
